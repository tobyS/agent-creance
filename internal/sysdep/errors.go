...
// implementations for Keychain and ProcessGroup.Start land with internal/cred
// (WP-4.1) and internal/cage (WP-4.3) respectively. (Flock's real impl landed
// with the proxy lifecycle, WP-3.4.) Callers and tests can errors.Is against it.
